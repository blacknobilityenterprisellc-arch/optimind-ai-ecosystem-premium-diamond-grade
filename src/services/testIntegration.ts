...
async function testIntegration() {
  ...
  try {
    ...
    try {
      ...
      const result = await integration.analyzeAndPersistImage(imageId, imageBuffer, {
    ...
    const dummyResult = await integration.analyzeAndPersistImage(dummyImageId, dummyBuffer, {
      filename: 'dummy.jpg',
      contentType: 'image/jpeg',
