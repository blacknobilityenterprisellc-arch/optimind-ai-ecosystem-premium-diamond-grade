...
export const OPENROUTER_MODELS: OpenRouterModelConfig[] = [
  ...
  },
  {
    ...
    temperature: 1,
    systemPrompt:
      "You are O1 Mini, a fast reasoning model with strong problem-solving abilities.",
    provider: "OpenAI",
  ...
  },
  {
    ...
    temperature: 0.7,
    systemPrompt:
      "You are Claude 3.5 Haiku, a fast and efficient AI assistant.",
    provider: "Anthropic",
  ...
  },
  {
    ...
    temperature: 0.7,
    systemPrompt:
      "You are Gemini Flash, a fast and efficient AI assistant from Google.",
    provider: "Google",
  ...
  // Meta Models
  {
    ...
    temperature: 0.7,
    systemPrompt:
      "You are Llama 3.1 70B, Meta's advanced large language model.",
    provider: "Meta",
  ...
  },
  {
    ...
    temperature: 0.7,
    systemPrompt:
      "You are Llama 3.1 8B, a fast and efficient language model from Meta.",
    provider: "Meta",
...
class OpenRouterService {
  ...
  async analyzeWithModel(
    ...
    try {
      ...
      console.error(
        `Open Router analysis failed for model ${request.modelId}:`,
        error,
      );
      throw new Error(
        `Open Router analysis failed: ${error?.message || "Unknown error"}`,
      );
    }
  }
  ...
  private parseResponse(response: any): any {
    ...
    try {
      ...
      console.warn(
        "Failed to parse JSON response from Open Router, returning raw content:",
        error,
      );
      return {
        rawResponse: content,
  ...
  async testModelConnection(modelId: string): Promise<boolean> {
    try {
      ...
      console.error(
        `Open Router model connection test failed for ${modelId}:`,
        error,
      );
      return false;
    }
