...
import { mcpServiceOrchestrator, MCPBusinessRequest, MCPBusinessResponse } from './mcp-service-orchestrator';
import { db } from './db';
...
class ContractWiseService {
  async analyzeContract(
    ...
    // Save to database
    const dbRecord = await this.saveToDatabase(userId, projectId, request, contractResult, mcpResponse);
  ...
  // Utility methods
  getContractTypes(): Array<{ value: string; label: string; description: string }> {
    return [
      { value: 'employment', label: 'Employment Contract', description: 'Employee-employer agreements' },
      { value: 'service', label: 'Service Agreement', description: 'Service provision contracts' },
      { value: 'nda', label: 'NDA', description: 'Non-disclosure agreements' },
      { value: 'partnership', label: 'Partnership Agreement', description: 'Business partnership contracts' },
      { value: 'sales', label: 'Sales Contract', description: 'Goods and services sales' },
      { value: 'lease', label: 'Lease Agreement', description: 'Property and equipment leases' },
      { value: 'license', label: 'License Agreement', description: 'Intellectual property licenses' },
      { value: 'franchise', label: 'Franchise Agreement', description: 'Franchise business agreements' },
      { value: 'merger', label: 'Merger Agreement', description: 'Business merger contracts' },
      { value: 'acquisition', label: 'Acquisition Agreement', description: 'Business acquisition contracts' }
    ];
  }
