    ...
    <div className="container mx-auto p-6 max-w-4xl">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">
          Z.AI GLM-4.5 Content Moderation System
        </h1>
      ...
      <div className="grid gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Select an image to analyze with GLM-4.5V, GLM-4.5-AIR, and GLM-4.5
              models
            </CardDescription>
          </CardHeader>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Badge
                          ...
                          className={getActionColor(
                            result.consensus.recommendedAction,
                          )}
                        >
                          {getActionIcon(result.consensus.recommendedAction)}
                          <span className="ml-1 capitalize">
                            {result.consensus.recommendedAction.replace(
                              "_",
                              " ",
                            )}
                          </span>
                      ...
                      {result.analysisDetails?.modelsUsed && (
                        <div className="space-y-2">
                          ...
                          <div className="flex gap-2">
                            {result.analysisDetails.modelsUsed.map(
                              (model, index) => (
                      ...
                      {result.analysisDetails?.reviewNeeded && (
                        <Alert>
                          ...
                          <AlertDescription>
                            This image has been flagged for human review due to
