      ...
      const mockReports: Report[] = [
        {
          ...
          status: "completed",
          summary:
            "Overall system health excellent with 94% test coverage and 99.9% reliability",
          keyMetrics: {
            coverage: 94.2,
            reliability: 99.9,
            performance: 87.5,
        ...
        },
        {
          ...
          status: "completed",
          summary:
            "Detailed technical analysis showing areas for optimization and improvement",
          keyMetrics: {
            coverage: 91.8,
            reliability: 98.7,
            performance: 82.3,
      ...
      const mockAlerts: Alert[] = [
        {
          ...
          message:
            "High-severity security vulnerability detected in authentication module",
          severity: "critical",
          category: "Security",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Monthly report and alert statistics
                </CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <TabsContent value="reports" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Available reports and their status
              </CardDescription>
            </CardHeader>
            <CardContent>
                      ...
                      <div className="grid grid-cols-2 gap-2 text-xs">
                        <div>
                          ...
                          <span className="font-medium ml-1">
                            {report.keyMetrics.coverage}%
                          </span>
                        </div>
                        <div>
                          <span className="text-gray-500">Reliability:</span>
                          <span className="font-medium ml-1">
                            {report.keyMetrics.reliability}%
                          </span>
                        </div>
                        <div>
