    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Comprehensive reporting and real-time alerting system</p>
        </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <span className="text-red-700 ml-2">
                  {alerts.filter(a => a.severity === 'critical' && !a.resolved).length} critical alerts require immediate attention
                </span>
              </div>
                  ...
                  <div key={report.id} className="flex items-center justify-between p-4 border rounded-lg">
                    <div className="flex items-center space-x-4">
                      <div className={`w-3 h-3 rounded-full ${
                        ...
                        report.status === 'generating' ? 'bg-blue-500' :
                        'bg-red-500'
                      }`} />
                      <div>
