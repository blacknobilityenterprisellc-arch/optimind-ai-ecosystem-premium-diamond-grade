...
const OptiTestAIDashboard: React.FC = () => {
  ...
  const [qualityPrediction, setQualityPrediction] =
    useState<QualityPrediction | null>(null);
        ...
        >
          <AlertDescription>
            <div className="flex items-center justify-between">
              <div>
                <span
                  className={`font-semibold ${getRiskColor(qualityPrediction.riskLevel)}`}
                >
                  {qualityPrediction.riskLevel.toUpperCase()} RISK
                </span>
                <span className="text-gray-600 ml-2">
                  Confidence: {qualityPrediction.confidence}% | Predicted
                  Failures: {qualityPrediction.predictedFailures}
                </span>
              </div>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-2 mt-1">
                          <Badge
                            className={getTypeColor(test.type)}
                            variant="outline"
                          >
        ...
        <TabsContent value="coverage" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Detailed coverage breakdown by test type
              </CardDescription>
            </CardHeader>
            <CardContent>
