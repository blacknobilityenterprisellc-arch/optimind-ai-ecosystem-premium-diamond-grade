...
export default function OptimizationPage() {
  ...
  const aeoInsights: AEOInsight[] = [
    ...
    },
    {
      ...
      description:
        "Optimize content for natural language queries and voice search patterns",
      impact: "high",
      implementation: "easy",
    },
    {
    ...
    },
    {
      ...
      description:
        "Add FAQ schema to increase chances of appearing in rich results",
      impact: "medium",
      implementation: "easy",
    },
    {
      ...
      description:
        "Optimize for local search queries and Google Business Profile",
      impact: "medium",
      implementation: "easy",
    },
  ];
                  ...
                  {optimizationScores.map((score) => (
                    <div key={score.category} className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <span
                          className={`text-sm font-medium ${getStatusColor(score.status)}`}
                        >
                          {score.score}%
                        </span>
                      </div>
                ...
                <div className="space-y-2">
                  ...
                  <ul className="space-y-1 text-xs">
                    <li className="flex items-start space-x-2">
                      ...
                      <span>
                        Add FAQ schema to increase snippet chances by 40%
                      </span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <Star className="w-3 h-3 text-yellow-500 mt-0.5 flex-shrink-0" />
                    ...
                    <li className="flex items-start space-x-2">
                      <Star className="w-3 h-3 text-yellow-500 mt-0.5 flex-shrink-0" />
                      <span>
                        Improve content readability for voice assistants
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <ul className="space-y-1 text-xs">
                    <li className="flex items-start space-x-2">
                      ...
                      <span>
                        Expand into Asian markets with localized content
                      </span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <Award className="w-3 h-3 text-yellow-500 mt-0.5 flex-shrink-0" />
                    ...
                    <li className="flex items-start space-x-2">
                      <Award className="w-3 h-3 text-yellow-500 mt-0.5 flex-shrink-0" />
                      <span>
                        Implement hreflang tags for better international SEO
                      </span>
                    </li>
                  </ul>
                </div>
        ...
        <TabsContent value="competitor" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Advanced competitor analysis with AI-powered insights and
                recommendations
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="freshness" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Monitor and maintain content freshness to ensure optimal SEO
                performance
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="space-y-2">
                  ...
                  <ul className="space-y-1 text-xs">
                    <li className="flex items-start space-x-2">
                      ...
                      <span>
                        Optimize images to reduce page load time by 40%
                      </span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <Zap className="w-3 h-3 text-yellow-500 mt-0.5 flex-shrink-0" />
        ...
        <TabsContent value="optimization" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Refresh and optimize your existing content for maximum SEO
                impact
              </CardDescription>
            </CardHeader>
            <CardContent>
