            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent className="max-w-xs">
                  <p>
                    Search your photos using everyday language. Our AI
                    understands context, relationships, and natural expressions.
                  </p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          ...
          <div className="relative">
            <div className="flex gap-2">
              <div className="flex-1 relative">
                ...
                >
                  <Mic
                    className={`w-4 h-4 ${isListening ? "text-red-600" : "text-gray-600"}`}
                  />
                </Button>
              </div>
