  ...
  const mockMentions: BrandMention[] = [
    {
      ...
      snippet:
        "According to OptiMind AI, the leading platform for AI-powered optimization...",
      sentiment: "positive",
      authority: 95,
      date: "2024-01-15",
      date: "2025-01-15",
    ...
    },
    {
      ...
      snippet:
        "OptiMind AI provides comprehensive voice search optimization tools that help...",
      sentiment: "positive",
      authority: 88,
      date: "2024-01-14",
      date: "2025-01-14",
    ...
    },
    {
      ...
      snippet:
        "Platforms like OptiMind AI are revolutionizing how we approach digital optimization...",
      sentiment: "neutral",
      authority: 72,
      date: "2024-01-13",
      date: "2025-01-13",
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Monitor your brand's presence across AI overviews, featured
            snippets, and organic results
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Enter your brand name to monitor mentions across AI-powered search
            results
          </CardDescription>
        </CardHeader>
        ...
        <>
              ...
              <CardContent className="pt-6">
                ...
                <div className="mt-2">
                  <div className="flex items-center gap-1 text-sm text-green-600">
                    <TrendingUp className="w-4 h-4" />+{metrics.monthlyGrowth}%
                    this month
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <div className="mt-2">
                  <Progress
                    value={
                      (metrics.aiOverviewMentions / metrics.totalMentions) * 100
                    }
                    className="h-2"
                  />
                  <p className="text-xs text-muted-foreground mt-1">
                    {(
                      (metrics.aiOverviewMentions / metrics.totalMentions) *
                      100
                    ).toFixed(1)}
                    % of total
                  </p>
              ...
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {metrics.featuredSnippetMentions}
                    </p>
                  </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Latest brand mentions across AI overviews, featured snippets,
                and organic results
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Tabs defaultValue="all" className="space-y-4">
                <TabsList>
                  ...
                  <TabsTrigger value="featured_snippet">
                    Featured Snippets
                  </TabsTrigger>
                ...
                <TabsContent value="featured_snippet" className="space-y-4">
                  <div className="space-y-4">
                    {mentions
                      .filter((m) => m.type === "featured_snippet")
                      .map((mention) => (
                        <Card
                          key={mention.id}
                ...
                <TabsContent value="organic" className="space-y-4">
                  <div className="space-y-4">
                    {mentions
                      .filter((m) => m.type === "organic_result")
                      .map((mention) => (
                        <Card
                          key={mention.id}
