  ...
  useEffect(() => {
    ...
    const mockPredictions: AIPrediction[] = [
      {
        ...
        reasoning:
          "AI analysis shows 98% safe content with minimal privacy concerns",
        timestamp: new Date(),
      },
      {
        id: "2",
        ...
        reasoning:
          "Historical data suggests upcoming uploads will be high resolution",
    ...
    const mockInsights: AIInsight[] = [
      ...
      },
      {
        ...
        description:
          "Login from new location detected - additional verification recommended",
        impact: "high",
        actionable: true,
      ...
      },
      {
        ...
        description:
          "AI can optimize storage usage by 23% through smart compression",
        impact: "medium",
        actionable: true,
          ...
          <Card className="premium-card">
            ...
            <CardContent>
              ...
              <Alert className="mt-4">
                <Brain className="w-4 h-4" />
                <AlertDescription>
                  AI predictions are based on machine learning analysis of your
                  usage patterns and historical data. Accuracy improves over
                  time as the system learns from your behavior.
                </AlertDescription>
              </Alert>
            </CardContent>
          </Card>
            ...
            <CardContent>
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg border border-purple-200">
                ...
                <p className="text-xs text-purple-700">
                  Our AI automatically analyzes your photos and generates
                  intelligent tags for better organization. The system learns
