  ...
  const testimonials = [
    {
      ...
      avatar: 'SJ',
      content:
        "OptiMind AI has completely transformed our workflow. The AI integration is seamless, and the performance is outstanding. We've seen a 300% increase in productivity since implementation.",
      rating: 5,
      date: '2 weeks ago',
      verified: true,
      industry: 'Technology',
    ...
    },
    {
      ...
      avatar: 'MC',
      content:
        "The most intuitive and powerful AI ecosystem we've ever used. The user interface is clean, the features are robust, and the support team is exceptional. Highly recommended!",
      rating: 5,
      date: '1 month ago',
      verified: true,
      industry: 'Startup',
    ...
    },
    {
      ...
      avatar: 'ER',
      content:
        'The accessibility features and responsive design make it perfect for our diverse team. The real-time analytics have helped us make data-driven decisions faster than ever before.',
      rating: 5,
      date: '3 weeks ago',
      verified: true,
    ...
    },
    {
      ...
      avatar: 'DT',
      content:
        'Enterprise-grade security combined with lightning-fast performance. OptiMind AI has become the backbone of our data processing pipeline. Absolutely worth every penny.',
      rating: 5,
      date: '1 week ago',
      verified: true,
      industry: 'Analytics',
    ...
    },
    {
      ...
      avatar: 'LW',
      content:
        "The scalability and reliability of OptiMind AI are unmatched. We've scaled from 100 to 10,000 users without any performance degradation. Truly enterprise-grade solution.",
      rating: 5,
      date: '2 months ago',
      verified: true,
      industry: 'Enterprise',
      ...
      <div className="relative container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Hear from our satisfied customers who have transformed their businesses with OptiMind
            AI's powerful ecosystem.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-white rounded-3xl p-8 shadow-lg">
            ...
            <div className="flex flex-wrap justify-center items-center space-x-8 space-y-4 md:space-y-0 opacity-60">
              {['G2 Crowd', 'Capterra', 'Software Advice', 'TrustRadius', 'PCMag', 'TechRadar'].map(
                (award, index) => (
                  <motion.div
                    key={award}
                    initial={{ opacity: 0, scale: 0.8 }}
